...
TAMU_6_AB_HASH_DAHA_LOG=${DIR_PATH}/tamu_6_ab_hash_daha.log
rm $TAMU_6_AB_HASH_DAHA_LOG
cd ../..
bash clean.sh
mkdir build
cd build
...
for dataset in ${tamu_dataset_list[@]}; do
	$NUMACTL --physcpubind=$CORE_RANGE ./bin/ab_hashspgemm $dataset >> $TAMU_6_AB_HASH_DAHA_LOG 2>&1
done
bash clean.sh
cd ${CUR_DIR}
...
TAMU_1_AB_HASH_DAHA_LOG=${DIR_PATH}/tamu_1_ab_hash_daha.log
rm $TAMU_1_AB_HASH_DAHA_LOG
cd ../..
bash clean.sh
mkdir build
cd build
...
cd ..
for dataset in ${tamu_dataset_list[@]}; do
	$NUMACTL --physcpubind=$CORE_RANGE ./bin/ab_hashspgemm $dataset >> $TAMU_1_AB_HASH_DAHA_LOG 2>&1
done
bash clean.sh
cd ${CUR_DIR}
...
TAMU_6_AB_HSERSC_DAHA_LOG=${DIR_PATH}/tamu_6_ab_hsersc_daha.log
rm $TAMU_6_AB_HSERSC_DAHA_LOG
cd ../..
bash clean.sh
mkdir build
cd build
...
cd ..
for dataset in ${tamu_dataset_list[@]}; do
	$NUMACTL --physcpubind=$CORE_RANGE ./bin/ab_hserscspgemm $dataset >> $TAMU_6_AB_HSERSC_DAHA_LOG 2>&1
done
bash clean.sh
cd ${CUR_DIR}
...
TAMU_1_AB_HSERSC_DAHA_LOG=${DIR_PATH}/tamu_1_ab_hsersc_daha.log
rm $TAMU_1_AB_HSERSC_DAHA_LOG
cd ../..
bash clean.sh
mkdir build
cd build
...
cd ..
for dataset in ${tamu_dataset_list[@]}; do
	$NUMACTL --physcpubind=$CORE_RANGE ./bin/ab_hserscspgemm $dataset >> $TAMU_1_AB_HSERSC_DAHA_LOG 2>&1
done
bash clean.sh
cd ${CUR_DIR}
